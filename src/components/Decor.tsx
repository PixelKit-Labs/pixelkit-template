...
const styles = StyleSheet.create({
  ...
  teleLabel: { ...Type.mono, fontSize: 11, letterSpacing: Platform.OS === 'android' ? 0 : 1, paddingRight: Platform.OS === 'android' ? 4 : 0, color: Colors.dark.textMuted, flexShrink: 0, marginRight: 8 },
  teleValue: { ...Type.mono, marginLeft: 'auto', textAlign: 'right', flexShrink: 1, letterSpacing: Platform.OS === 'android' ? 0 : undefined },
