...
export const HOOK_HOMES: Record<string, HookHome> = {
  ...
  useADPFHintSession: { tab: 'silicon', section: 'compute' },
  // Silicon · system
  useDevice: { tab: 'silicon', section: 'system' },
  useDisplay: { tab: 'silicon', section: 'system' },
  useCapabilities: { tab: 'silicon', section: 'system' },
  useBatteryShare: { tab: 'silicon', section: 'system' },
  useChargingIntelligence: { tab: 'silicon', section: 'system' },
  // Silicon · network
  ...
  useEmbeddings: { tab: 'ai', section: 'tasks' },
  ...
  useMicrophoneArray: { tab: 'sensors', section: 'audio' },
  ...
  useThermometer: { tab: 'sensors', section: 'actuators' },
  ...
  useWifi7MLO: { tab: 'sensors', section: 'radios' },
  useWifiRTT: { tab: 'sensors', section: 'radios' },
  useSatelliteNTN: { tab: 'sensors', section: 'radios' },
  ...
  usePrivateSpace: { tab: 'sensors', section: 'security' },
  useKeyAgreement: { tab: 'sensors', section: 'security' },
};
