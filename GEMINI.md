...
6. **Single import.** Hooks come from `@pixelkit-labs/sdk`, and the four ML Kit hooks from `@pixelkit-labs/sdk/mlkit`. Never reach into `node_modules`. Components and theme are local to this repository and imported by relative path.
